  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={cn(
          "fixed top-0 left-0 right-0 z-40 flex items-center justify-between transition-all duration-300 font-sans text-[0.56rem] sm:text-[0.65rem] uppercase tracking-[0.2em] sm:tracking-[0.45em]",
        ...
        >
          {logo || (
            <Image
              ...
              height={44}
              className={cn(
                "h-auto w-[110px] sm:w-[150px] transition-all duration-300",
                "brightness-0 invert",
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-30 bg-background text-foreground font-serif uppercase tracking-[0.1em] sm:tracking-[0.3em] overflow-y-auto overscroll-contain"
            style={{
          ...
          >
            <nav className="mx-auto flex min-h-full w-full max-w-3xl flex-col justify-start gap-1 px-1 py-2 sm:gap-2 sm:px-4">
              {navLinks.map((link, index) => (
                <motion.div
                  ...
                  className="w-full border-b border-foreground/10 px-2 pb-4 pt-2 text-start sm:border-b-0 sm:px-0 sm:py-0 sm:text-center"
                >
                  {link.children && link.children.length > 0 ? (
                    ...
                    <div className="flex flex-col items-start sm:items-center">
                      <button
                        ...
                        className="group relative inline-block text-2xl sm:text-4xl md:text-6xl font-semibold transition-colors hover:opacity-60 active:opacity-50 touch-manipulation py-1.5 sm:py-2 cursor-pointer"
                      >
                        {link.name}
                      </button>
                      ...
                      <AnimatePresence>
                        {expandedMenus.has(link.name) && (
                          <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                            className="mt-3 flex w-full flex-col items-start space-y-1.5 border-s border-foreground/15 ps-3 sm:mt-4 sm:items-center sm:space-y-3 sm:border-s-0 sm:ps-0"
                          >
                            {link.children.map((child, childIndex) => (
                              ...
                              >
                                <Link
                                  href={child.href}
                                  onClick={toggleMenu}
                                  className="group relative inline-block text-sm sm:text-xl md:text-3xl font-normal opacity-70 hover:opacity-100 transition-all duration-300 touch-manipulation py-1 px-1 sm:px-4"
                                >
                                  {child.name}
                                  <motion.span
                                    className="absolute -bottom-0.5 left-1 right-1 h-px w-0 bg-background/50 sm:left-4 sm:right-4"
                    ...
                    <Link
                      href={link.href}
                      onClick={toggleMenu}
                      className="group relative inline-block text-2xl sm:text-4xl md:text-6xl font-semibold transition-colors hover:opacity-60 active:opacity-50 touch-manipulation py-1.5 sm:py-2"
                    >
                      {link.name}
                      <motion.span
              ...
              <motion.div
                ...
                className="mt-6 flex w-full flex-col items-start gap-5 border-t border-foreground/10 pt-5 sm:mt-10 sm:items-center sm:gap-6 sm:pt-6"
              >
                ...
                {/* Social Links */}
                <div className="flex w-full items-center justify-start gap-2 border-t border-foreground/10 pt-4 sm:justify-center sm:gap-6">
                  <a
                    href="#"
                    className="group flex flex-col items-center gap-1.5 transition-opacity hover:opacity-100 active:opacity-100 opacity-70 touch-manipulation p-2 sm:gap-2"
                  ...
                  >
                    ...
                    <span className="text-[0.56rem] sm:text-xs font-sans uppercase tracking-[0.15em] sm:tracking-[0.4em]">Instagram</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-[0.56rem] sm:text-xs font-sans uppercase tracking-[0.15em] sm:tracking-[0.4em]">Twitter</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-[0.56rem] sm:text-xs font-sans uppercase tracking-[0.15em] sm:tracking-[0.4em]">LinkedIn</span>
                  </a>
                </div>
              </motion.div>
            </nav>
