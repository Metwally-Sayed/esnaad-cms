      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 sm:space-y-12">
            ...
            {error && (
              <div className="text-center text-destructive text-sm font-serif">
                {error}
              </div>
            )}
            ...
            <div className="pt-12 flex justify-center">
              <Button
                ...
                size="lg"
                disabled={isPending}
                className="w-full md:w-auto min-w-[300px] uppercase tracking-[0.1em] h-14 text-lg border-border hover:bg-secondary/10 rounded-none font-serif transition-all disabled:opacity-50"
              >
